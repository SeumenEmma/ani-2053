## reconstruisons NKMath 

Dans NKMath j ai introduit un erreur ca donne : 
```
...
╠══════════════════════════════════════════════════════════════════════════════════════════════╣
║ C:\Users\emmas\Downloads\Nkentseu\Nkentseu-main\Kernel\Foundation\NKMath\src\NKMath\NkMat.cp ║
║ p:5:24: error: expected '}'                                                                  ║
║     5 | } // namespace nkentseu                                                              ║
║       |                        ^                                                             ║
║ C:\Users\emmas\Downloads\Nkentseu\Nkentseu-main\Kernel\Foundation\NKMath\src\NKMath\NkMat.cp ║
║ p:3:20: note: to match this '{'                                                              ║
║     3 | namespace nkentseu {                                                                 ║
║       |                    ^                                                                 ║
║ 1 error generated.                                                                           ║
╚══════════════════════════════════════════════════════════════════════════════════════════════╝

✗ ✗ Compilation failed: C:\Users\emmas\Downloads\Nkentseu\Nkentseu-main\Kernel\Foundation\NKMath\src\NKMath\NkMat.cpp

┌──────────────────────────────────────────────────────────────────────────────────────────────┐
│  ✗ Build Failed                                                                 Time: 1.11s  │
...
Apres avoir taper cette commande 
```
...
Il y as 4 projets qui ont ete construit 

## Ce que l erreur montre sur l ordre de construction

L erreur de syntaxe introduit dans NKMath provoque l echec de la compilation de NKmath. Ce qui montre que l ordre de construction est determinees par les dependances entre les projets. 